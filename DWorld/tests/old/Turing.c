...
PetscErrorCode InitialCondition_Turing( DA da, Vec vec_chem );
...
int main(int argc, char **args)
{
  ...
  */
  ...
  ierr = DWorldCreate(rxnEC, num, len, &world); CHKERRQ(ierr);
  ierr = InitialCondition_Turing(world->da, world->global); CHKERRQ(ierr);
  /* Load check-point
  PetscViewer in;
